...
import DepoimentoCarousel from "@/app/components/depoimentoCarousel";
  ...
  const testimonials = [
    {
      ...
      texto:
        "Durante o decorrer de 1 ano, a equipe da CJR fez um ótimo trabalho construindo a nova plataforma do Selo Social de treinamento e qualificação de lideranças para o desenvolvimento de projetos alinhados aos Objetivos de Desenvolvimento Sustentável (ODS). O processo foi longo, por ser uma plataforma bastante complexa. No entanto, mesmo sendo um trabalho difícil, a equipe sempre foi muito prestativa, estando disponível para responder dúvidas e resolver todos os conflitos necessários durante todo o desenvolvimento do projeto, o que resultou em uma entrega fidedigna ao que foi pedido desde o início quando foi solicitado o serviço",
      imgSrc: "/carina.png",
      nome: "Carina Giunco",
    ...
    },
    {
      ...
      texto:
        '"Ser um dos líders da empresa com certeza foi um dos melhores anos da minha vida. Me fez entender que liderar um time não é só passar tarefas. É sobre entender um pouquinho de cada coisa e ajudar a galera a ter um ponto de partida. Depois, as coisas andam, o time acredita naquilo que está fazendo e todo mundo cresce junto. Tudo bem que, além da CJR, eu consegui um estágio, mas isso é o de menos eu acho. A CJR abriu minhas perspectivas e me possibilitou conhecer pessoas incríveis que estão comigo na caminhada até hoje. Enxergo, hoje, a possibilidade de empreender e gerar valor de uma forma diferente, que eu realmente gosto. Me juntei a quatro CJotinhas que também enxergam essa possibilidade e hoje temos uma Startup."',
