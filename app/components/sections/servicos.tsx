...
import ServiceBox from "./servicos/containerServico";
        ...
        <div className="flex justify-center items-center mt-10">
          <div className="grid md:grid-cols-3 gap-6 px-10 w-fit">
            <ServiceBox
              ...
              descricao_back="Sistemas Web são aplicações que rodam em um servidor e são acessadas via navegador"
            />
            <ServiceBox
              icone={consultoriaIcon}
              tipo="Consultoria"
              descricao="Prestação de consultas profissionais visando atender as necessidades do cliente"
              descricao_back="Consultoria é um serviço de aconselhamento e orientação profissional"
            />
            <ServiceBox
              icone={PWAIcon}
              tipo="PWA"
              descricao="Desenvolvimento de Progressive Web Apps para melhorar a experiência do usuário"
              descricao_back="Progressive Web Apps são aplicações web que oferecem uma experiência semelhante a aplicativos nativos"
            />
            <ServiceBox
              icone={ecommerceIcon}
              tipo="E-Commerce"
              descricao="Desenvolvimento de lojas virtuais para venda de produtos e serviços"
              descricao_back="E-Commerce é a abreviação de Electronic Commerce, ou seja, comércio eletrônico"
            />
            <ServiceBox
              icone={appIcon}
              tipo="Aplicativo Móvel"
              descricao="Desenvolvimento de aplicativos móveis para Android e iOS"
              descricao_back="Aplicativos móveis são programas desenvolvidos para dispositivos móveis"
            />
            <ServiceBox
              ...
              descricao_back="Sites institucionais são páginas web que apresentam informações sobre uma empresa ou serviço"
            />
          </div>
        </div>
      </section>
